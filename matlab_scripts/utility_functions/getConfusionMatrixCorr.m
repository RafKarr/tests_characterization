function [confusionMatrix,type1Errors,type2Errors] = getConfusionMatrixCorr(traces,comparedInputs,threshold)
%GETCONFUSIONMATRIXCORR Get the confusion matrix of this with threshold
